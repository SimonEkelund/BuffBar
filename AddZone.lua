...
function AddZone:Initialize()
    ...
    frame:SetScript("OnEnter", function(self)
        ...
        GameTooltip:AddLine("Right-click a tracked slot to remove it.", 1, 1, 1, true)
        GameTooltip:AddLine("Drag a slot to reorder; drag far outside to remove.", 0.7, 0.7, 0.7, true)
        GameTooltip:AddLine("Lock the bar to right-click slots for item use.", 0.7, 0.7, 0.7, true)
        GameTooltip:Show()
